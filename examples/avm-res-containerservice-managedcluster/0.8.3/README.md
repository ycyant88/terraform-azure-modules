...
> Upgrading an existing deployment? Follow the [AzureRM interface migration guide](MIGRATION.md) before applying a new module version.
...
- [azapi_resource_list.diagnostic_settings_categories](https://registry.terraform.io/providers/Azure/azapi/latest/docs/data-sources/resource_list) (data source)
