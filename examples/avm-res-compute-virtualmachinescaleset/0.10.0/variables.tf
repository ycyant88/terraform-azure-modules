...
variable "automatic_instance_repair" {
  ...
  default = { "enabled" : true, "grace_period" : "PT30M" }
}
...
variable "os_disk" {
  ...
  default = { "caching" : "ReadWrite", "delete_option" : "Delete", "storage_account_type" : "Premium_LRS", "write_accelerator_enabled" : false }
}
