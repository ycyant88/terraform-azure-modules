...
data_collection_rules = { "change_tracking" : { "name" : "dcr-change-tracking" }, "defender_sql" : { "name" : "dcr-defender-sql" }, "vm_insights" : { "name" : "dcr-vm-insights" } }
...
log_analytics_solution_plans = [{ "product" : "OMSGallery/ContainerInsights", "publisher" : "Microsoft" }, { "product" : "OMSGallery/VMInsights", "publisher" : "Microsoft" }]
...
user_assigned_managed_identities = { "ama" : { "name" : "uami-ama" } }
