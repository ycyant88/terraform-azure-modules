...
variable "default_image_repository_folder_paths" {
  ...
  type        = map(string)
  default     = { "azuredevops-container-app" : "container-images/azure-devops-agent-aca", "azuredevops-container-instance" : "container-images/azure-devops-agent-aci", "github-container-app" : "container-images/github-runner-aca", "github-container-instance" : "container-images/github-runner-aci" }
}
...
variable "delays" {
  ...
  default = { "delay_after_container_image_build" : 30 }
}
