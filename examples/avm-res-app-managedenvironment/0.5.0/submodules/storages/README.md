...
### <a name="input_account_key"></a> [account\_key](#input\_account\_key)
...
### <a name="input_account_key_version"></a> [account\_key\_version](#input\_account\_key\_version)

Description: Version tracker for account\_key. Must be set when account\_key is provided.

Type: `number`

Default: `null`

### <a name="input_azure_file"></a> [azure\_file](#input\_azure\_file)
...
### <a name="input_nfs_azure_file"></a> [nfs\_azure\_file](#input\_nfs\_azure\_file)
