output "certificate_resource_ids" {
  value       = module.avm-res-app-managedenvironment.certificate_resource_ids
...
output "dapr_ai_instrumentation_key" {
  value       = module.avm-res-app-managedenvironment.dapr_ai_instrumentation_key
...
output "event_stream_endpoint" {
  value       = module.avm-res-app-managedenvironment.event_stream_endpoint
...
output "managed_certificate_resource_ids" {
  value       = module.avm-res-app-managedenvironment.managed_certificate_resource_ids
