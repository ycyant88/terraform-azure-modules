output "firewall_policies" {
  value       = module.avm-ptn-hubnetworking.firewall_policies
...
output "name" {
  value       = module.avm-ptn-hubnetworking.name
...
output "resource_id" {
  value       = module.avm-ptn-hubnetworking.resource_id
  description = "The resource IDs of the hub virtual networks."
}

output "test" {
  value       = module.avm-ptn-hubnetworking.test
  description = ""
}
