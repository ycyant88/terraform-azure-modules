module "avm-res-devopsinfrastructure-pool" {
  ...
  fabric_profile_os_profile_logon_type                = var.fabric_profile_os_profile_logon_type
  fabric_profile_sku_name                             = var.fabric_profile_sku_name
  location                                            = var.location
  lock                                                = var.lock
  managed_devops_pool_retry_on_error                  = var.managed_devops_pool_retry_on_error
  managed_devops_pool_timeouts                        = var.managed_devops_pool_timeouts
