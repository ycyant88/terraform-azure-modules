...
variable "configure_identity_resources" {
  ...
  default = { "settings" : { "identity" : { "config" : { "enable_deny_public_ip" : true, "enable_deny_rdp_from_internet" : true, "enable_deny_subnet_without_nsg" : true, "enable_deploy_azure_backup_on_vms" : true }, "enabled" : true } } }
}
...
variable "create_duration_delay" {
  ...
  default = { "azurerm_management_group" : "30s", "azurerm_policy_assignment" : "30s", "azurerm_policy_definition" : "30s", "azurerm_policy_set_definition" : "30s", "azurerm_role_assignment" : "0s", "azurerm_role_definition" : "60s" }
}
...
variable "destroy_duration_delay" {
  ...
  default = { "azurerm_management_group" : "0s", "azurerm_policy_assignment" : "0s", "azurerm_policy_definition" : "0s", "azurerm_policy_set_definition" : "0s", "azurerm_role_assignment" : "0s", "azurerm_role_definition" : "0s" }
}
