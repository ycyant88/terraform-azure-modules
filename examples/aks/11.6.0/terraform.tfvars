...
agents_pool_drain_timeout_in_minutes = null

agents_pool_kubelet_configs = []

agents_pool_linux_os_configs = []

agents_pool_local_dns_config = null

agents_pool_max_surge = "10%"

agents_pool_name = "nodepool"

agents_pool_node_soak_duration_in_minutes = 0

agents_pool_undrainable_node_behavior = null
...
create_monitor_data_collection_rule = true
...
data_collection_settings = { "container_log_v2_enabled" : true, "data_collection_interval" : "1m", "namespace_filtering_mode_for_data_collection" : "Off", "namespaces_for_data_collection" : ["kube-system", "gatekeeper-system", "azure-arc"] }
...
interval_before_cluster_update = "30s"
...
log_analytics_workspace_data_collection_rule_id = null

log_analytics_workspace_enabled = true

log_analytics_workspace_identity = null

log_analytics_workspace_immediate_data_purge_on_30_days_enabled = null
...
monitor_data_collection_rule_data_sources_syslog_facilities = ["auth", "authpriv", "cron", "daemon", "mark", "kern", "local0", "local1", "local2", "local3", "local4", "local5", "local6", "local7", "lpr", "mail", "news", "syslog", "user", "uucp"]

monitor_data_collection_rule_data_sources_syslog_levels = ["Debug", "Info", "Notice", "Warning", "Error", "Critical", "Alert", "Emergency"]

monitor_data_collection_rule_extensions_streams = ["Microsoft-ContainerLog", "Microsoft-ContainerLogV2", "Microsoft-KubeEvents", "Microsoft-KubePodInventory", "Microsoft-KubeNodeInventory", "Microsoft-KubePVInventory", "Microsoft-KubeServices", "Microsoft-KubeMonAgentEvents", "Microsoft-InsightsMetrics", "Microsoft-ContainerInventory", "Microsoft-ContainerNodeInventory", "Microsoft-Perf"]
...
net_profile_pod_cidrs = null

net_profile_service_cidr = null

net_profile_service_cidrs = null

network_contributor_role_assigned_subnet_ids = {}

network_ip_versions = null
...
network_profile_advanced_networking = null
...
windows_profile_admin_password = null
