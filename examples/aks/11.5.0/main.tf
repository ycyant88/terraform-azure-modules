module "aks" {
  ...
  agents_pool_local_dns_config                                    = var.agents_pool_local_dns_config
  ...
  agents_pool_undrainable_node_behavior                           = var.agents_pool_undrainable_node_behavior
  ...
  api_server_vnet_integration_enabled                             = var.api_server_vnet_integration_enabled
  ...
  network_profile_advanced_networking                             = var.network_profile_advanced_networking
  ...
  windows_profile_admin_password                                  = var.windows_profile_admin_password
