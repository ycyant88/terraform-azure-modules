...
variable "virtual_desktop_host_pool_custom_rdp_properties" {
  ...
  default = { "audiomode" : 0, "custom_properties" : {}, "devicestoredirect" : "*", "drivestoredirect" : "*", "enablecredsspsupport" : 1, "redirectclipboard" : 1, "redirectcomports" : 1, "redirectprinters" : 1, "redirectsmartcards" : 1, "usbdevicestoredirect" : "*", "use_multimon" : 0, "videoplaybackmode" : 1 }
}
