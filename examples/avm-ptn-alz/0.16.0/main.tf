module "avm-ptn-alz" {
  ...
  parent_id_overrides                                               = var.parent_id_overrides
  ...
  subscription_placement_destroy_move_to_parent_resource_id_enabled = var.subscription_placement_destroy_move_to_parent_resource_id_enabled
  subscription_placement_destroy_target_management_group_id         = var.subscription_placement_destroy_target_management_group_id
