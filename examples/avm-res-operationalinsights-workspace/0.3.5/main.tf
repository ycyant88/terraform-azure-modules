module "avm-res-operationalinsights-workspace" {
  ...
  monitor_private_link_scope_ingestion_access_mode           = var.monitor_private_link_scope_ingestion_access_mode
  monitor_private_link_scope_query_access_mode               = var.monitor_private_link_scope_query_access_mode
